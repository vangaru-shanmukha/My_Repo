...
# Requirements
- The filter of menu contents, a waiter can search by menu item ( by item name ex: biriyani), or by course type ( entree, main course, desserts, appetizers, beverages etc.)
- A waiter can filter tables by table names
...
- A waiter can click on any of the table items to get a detailed view of that table's orders.
- A table's order items can be increased say a person of table-1 wants to reorder an item the waiter can just update the number of servings or can delete the item if the customer canceled the order.
- [Assignment Link](https://docs.google.com/document/d/1mZ_17o_lygGkaCjUMef8vRCvCObRLHrIvhd6z6Hq0x0/edit)
